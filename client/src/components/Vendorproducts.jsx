...
const Vendorproducts = () => {
  ...
  <div className="w-72 h-72 m-2 bg-gray-200 rounded-xl p-12">
      <h1  className="bg-white w-48 h-48 text-2xl text-green-600 text-center p-8 hover:bg-green-400 hover:text-green-700"><Link to="/newproduct">ADD PRODUCT<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#0b8609" className="w-14 h-14 ml-9">
