...
const NewProduct = () => {
  const {categories,hostedRoutePrefix,updateProduct} = useContext(dataContext);
  ...
  const handleChange = (e) => {
    ...
    setFormData((prevData) => {
      if (name === "category") {
        ...
        return { ...prevData, [name]: value, category_id: selectedCategory ? selectedCategory.id : "" };
      } else {
  ...
  return (
    ...
    class=" min-w-screen min-h-screen  flex items-center justify-center px-5 py-5">
      <form
       ...
       className="outline outline-gray-100 m-14 ml-48 p-4 rounded-xl w-2/3 text-white" onSubmit={handleSubmit}>
        ...
        <button className="bg-green-600 justify-self-center hover:bg-green-700" type="submit">ADD</button>
