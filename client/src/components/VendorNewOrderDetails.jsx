...
const VendorNewOrderDetails = ({
  ...
  console.log(orderApprovalMessage);
      ...
      <div className="popup-content w-2/3 h-5/6 overflow-scroll  ">
        {orderApprovalMessage !== "" && (
          <div
            ...
            className={isOrderApproved ? "bg-green-500" : "bg-red-500"}
                ...
                <div className="flex justify-between xl:h-full  items-stretch w-full flex-col mt-6 md:mt-0">
                  ...
                  <div className="flex flex-col w-full justify-center items-center ">
                    <button
                      ...
                      className="md:mt-0 m-4 py-5 bg-green-900 text-base hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-900 border border-green-900 font-medium 2xl:w-full leading-4 text-white"
                    >
                      {isOrderApproved ? "Order Approved" : "Approve Order"}
                    </button>
                    <button
                      onClick={rejectOrderHandler}
                      className="md:mt-0 py-5 bg-red-900 text-base hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-900 border border-green-900 font-medium 2xl:w-full leading-4 text-white"
                    >
                      {isOrderApproved ? " Reject Order" : "Order Rejected"}
                    </button>
                  </div>
                </div>
              </div>
...
export default VendorNewOrderDetails;
